...
app.service("temp_cards_data", [
    ...
    function(objTemplate) {
        ...
        card.serve.faction = ["khador"];
        card.serve.card = [];
        card.serve.rule = ["rankkingOfficer"];
        ...
        //war dog
        var card = angular.copy(objTemplate.card);
        card.cardName = "war dog";
        card.subCardName = "khador solo";
        card.faction = "khador";
        card.category = "attechment";
        card.serve.faction = ["khador"];
        card.serve.category = ["warcaster"];
        card.serve.rule = ["serveFaction","serveCategory"];
        card.base="s";
        card.subCategory = null
        card.fa = 1;
        card.pc = 1;
        ...
        card.role[0].roleName = "war dog";

        card.role[0].damage = 5;
        card.role[0].status.spd = 7;
        card.role[0].status.str = 7;
        card.role[0].status.mat = 6;
        card.role[0].status.rat = 1;
        card.role[0].status.def = 13;
        card.role[0].status.arm = 14;
        card.role[0].status.cmd = 6;
        ...
        var card = angular.copy(objTemplate.card);
        card.cardName = "sylys wyshnalyrr,the seeker";
        card.subCardName = "mercenary seeker character solo";
        card.faction = "mercenary";
        card.category = "attechment";
        card.serve.faction = ["khador","cygnar","retribution"];
        card.serve.category = ["warcaster"];
        card.serve.rule = ["serveFaction","serveCategory"];
        card.base="s";
        card.subCategory = null
        ...
        card.role[0].roleName = "sylys";

        card.role[0].damage = 5;
        card.role[0].status.spd = 6;
        card.role[0].status.str = 4;
        card.role[0].status.mat = 5;
        card.role[0].status.rat = 4;
        card.role[0].status.def = 13;
        card.role[0].status.arm = 13;
        ...
        //anastasia di bray
        var card = angular.copy(objTemplate.card);
        card.cardName = "anastasia di bray";
        card.subCardName = "mercenary character solo";
        card.faction = "mercenary";
        card.category = "solo";
        card.serve.faction = ["khador","cygnar","mercenary"];
        card.serve.category = [];
        card.serve.rule = ["serveFaction"];
        card.base="s";
        card.subCategory = null
        card.fa = "c";
        card.pc = 2;
        ...
        card.role[0].roleName = "anastasia di bray";
